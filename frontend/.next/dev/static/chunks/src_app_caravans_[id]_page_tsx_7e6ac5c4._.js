...
function CaravanDetailPage() {
    _s();
    const { id } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"])(); // URL 파라미터 가져오기
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CaravanDetailPage.useEffect": ()=>{
            if (!id) return;
            const fetchCaravan = {
                "CaravanDetailPage.useEffect.fetchCaravan": async ()=>{
                    try {
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:3001/api/caravans/${id}`);
            ...
            }["CaravanDetailPage.useEffect.fetchCaravan"];
            fetchCaravan();
        }
    }["CaravanDetailPage.useEffect"], [
        id
    ...
    const handleReservation = async (e)=>{
        ...
        if (confirm(`총 ${totalPrice.toLocaleString()}원으로 예약을 요청하시겠습니까?`)) {
            ...
            try {
                // 예약 요청 API 호출
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("http://localhost:3001/api/reservations", {
                    caravanId: id,
                    guestId: user.id,
                    startDate,
                    endDate,
...
_s(CaravanDetailPage, "s8YJJYkDJ0yke4Kqp6qrfvlOr2k=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = CaravanDetailPage;
var _c;
__turbopack_context__.k.register(_c, "CaravanDetailPage");
