...
function CaravanDetailPage() {
            ...
            const fetchCaravan = {
                "CaravanDetailPage.useEffect.fetchCaravan": async ()=>{
                    try {
                        ...
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:3001/api/caravans/${id}`);
                        setCaravan(res.data);
                    } catch (err) {
    ...
    const handlePaymentConfirm = async ()=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:3001/api/reservations', payload);
...
_s(CaravanDetailPage, "dQAZFBZsNk9zKaQRffTLEm8IPMw=");
_c1 = CaravanDetailPage;
var _c, _c1;
__turbopack_context__.k.register(_c, "PaymentModal");
__turbopack_context__.k.register(_c1, "CaravanDetailPage");
