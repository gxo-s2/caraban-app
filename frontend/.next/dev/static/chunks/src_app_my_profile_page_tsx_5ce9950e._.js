...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/axios/lib/axios.js [app-client] (ecmascript)"); // fetch 대신 axios를 사용하여 오류 처리의 일관성을 확보합니다.
;
...
const ProfilePage = ()=>{
            ...
            const fetchUser = {
                "ProfilePage.useEffect.fetchUser": async ()=>{
                    ...
                    try {
                        ...
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API_BASE_URL}/${userId}`);
    ...
    const handleUpdate = async ()=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch(`${API_BASE_URL}/${user.id}`, {
                name,
                contactNumber
            });
            if (response.status !== 200) {
...
_s(ProfilePage, "Dg3ycYX8vKYcnc6BZr+UnM5aqG4=", false, function() {
    return [
