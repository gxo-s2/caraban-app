...
function HostReservationPage() {
    ...
    const fetchReservations = async (hostId)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`${API_URL}/host/${hostId}`);
    ...
    const handleUpdateStatus = async (reservationId, newStatus)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].patch(`${API_URL}/${reservationId}/status`, {
                status: newStatus,
                hostId: hostUser?.id
            });
