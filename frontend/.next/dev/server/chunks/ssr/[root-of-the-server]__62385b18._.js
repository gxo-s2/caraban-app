...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/axios/lib/axios.js [app-ssr] (ecmascript)"); // axios 대신 fetch를 사용해도 되지만, 일관성을 위해 axios를 사용합니다.
"use client";
;
;
;
...
function PaymentHistoryPage() {
    ...
    async function fetchPayments(currentUserId) {
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`${API_URL}?userId=${currentUserId}`);
            if (res.status !== 200) {
