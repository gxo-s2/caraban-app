...
function CaravanDetailPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const fetchCaravan = async ()=>{
            try {
                // ✅ [수정됨] 127.0.0.1을 사용하여 연결 안정성 확보
                const res = await fetch(`http://127.0.0.1:3001/api/caravans/${id}`);
                if (!res.ok) throw new Error('Failed to fetch caravan');
                const data = await res.json();
                setCaravan(data);
            } catch (err) {
                console.error(err);
                setError('카라반 정보를 불러올 수 없습니다. 백엔드 서버가 켜져 있는지 확인해주세요.');
            } finally{
                setLoading(false);
            }
        };
    ...
    const handlePaymentConfirm = async ()=>{
        ...
        try {
            ...
            // ✅ [수정됨] 127.0.0.1 사용 및 표준 fetch 옵션 적용
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.message || '예약 생성 실패');
            }
...
//# sourceMappingURL=src_app_caravans_%5Bid%5D_page_tsx_6e9303bb._.js.map